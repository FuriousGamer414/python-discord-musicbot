...
# Remove the command_prefix=None to allow mention-based command handling
...
@bot.event
async def on_ready():
    print(f"{bot.user.name} is online and ready to groove!")
...
async def play_next(ctx, voice_client):
    ...
    if queue:
        ...
        voice_client.play(source, after=lambda _: asyncio.run_coroutine_threadsafe(play_next(ctx, voice_client), bot.loop))
...
# Replace 'YOUR_DISCORD_BOT_TOKEN' with the environment variable
if DISCORD_TOKEN:
