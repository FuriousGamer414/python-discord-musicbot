...
from aiohttp import web  # For lightweight web server to satisfy Render's requirements
...
# Get the token and port from environment variables
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN')
PORT = int(os.getenv('PORT', 3000))  # Default to 8080 if PORT is not set
...
if DISCORD_TOKEN:
    ...
    # Simple web server for Render port binding
